...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        #添加权重
        src_b_c = src_boxes.detach()
        quan_zhong = (src_b_c - target_boxes)**2
        # quan_zhong_x = 1/((image_size*quanzhong_th)**2)
        # quan_zhong = quan_zhong * quan_zhong_x
        quan_zhong[quan_zhong > 1] = 1

        loss_bbox = F.l1_loss(src_boxes_, target_boxes_, reduction='none')
        loss_bbox = loss_bbox * quan_zhong
